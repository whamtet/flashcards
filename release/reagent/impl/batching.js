...
var or__5810__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__5810__auto__)){
return or__5810__auto__;
} else {
var or__5810__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__5810__auto____$1)){
return or__5810__auto____$1;
} else {
var or__5810__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__5810__auto____$2)){
return or__5810__auto____$2;
} else {
var or__5810__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__5810__auto____$3)){
return or__5810__auto____$3;
} else {
...
var n__6713__auto__ = a.length;
var i = (0);
while(true){
if((i < n__6713__auto__)){
var c_11727 = (a[i]);
if(cljs.core.truth_((c_11727["cljsIsDirty"]))){
(c_11727["forceUpdate"])();
} else {
}
...
var G__11730 = ((function (this$){
return (function (){
return this$.run_queue();
});})(this$))
;
return (reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1(G__11730) : reagent.impl.batching.next_tick.call(null,G__11730));
}
});
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__6408__auto__,writer__6409__auto__,opt__6410__auto__){
return cljs.core._write(writer__6409__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__11732 = c;
var G__11732__$1 = (((G__11732 == null))?null:(G__11732["props"]));
if((G__11732__$1 == null)){
return null;
} else {
return (G__11732__$1["argv"]);
}
});
...
var G__11734_11735 = (c["cljsRatom"]);
if((G__11734_11735 == null)){
} else {
reagent.ratom.dispose_BANG_(G__11734_11735);
}
